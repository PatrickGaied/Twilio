...
from routes.campaign_generator import router as campaign_generator_router
from routes.popup_generator import router as popup_generator_router
...
app.include_router(popup_generator_router)
